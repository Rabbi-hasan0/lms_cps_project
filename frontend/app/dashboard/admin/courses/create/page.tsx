...
export default function CreateCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ১. বর্তমান অ্যাডমিন ইউজার ফেচ করা (creator হিসেবে সেট করার জন্য)
      ...
      // ২. থাম্বনেইল থাকলে আগে Strapi upload API তে আপলোড করা
      if (thumbnailFile) {
      ...
      // ৩. Strapi তে কোর্স ডাটা পাঠানো (creator এবং instructor সহ)
      const coursePayload: any = {
        title: formData.title.trim(),
        description: formData.description.trim(),
        creator: me.id, // অ্যাডমিন ইউজারের আইডি creator ফিল্ডে পাস করা হলো
      };
